...
├── test_items/                     44 held-out test item files (5,052 items)
│
...
Results are saved to `validation_results_1536.csv` (or `_3072.csv`). The `test_items/` directory contains 44 JSON files with 5,052 held-out items generated by GPT-4o, each with an expected factor label and confidence rating.
