...
| +RQ7 (3072-dim embeddings) | 44 models | 63.8% | +5.1% |
| +RQ8 (data augmentation) | 14 targeted | 61.1% | +25.9%\* |
| +RQ9 (hierarchical classifiers) | 8 targeted | 39.9% | +4.8%\* |
| **Combined best-per-model** | **44 models** | **71.5%** | **+12.9%** |

\*Delta computed against baseline for the same targeted subset.

**Top 5 improvers:** WAIS +42.1%, EM +40.6%, DISC +37.4%, TKI +36.5%, TEI +32.7%
