...
| **Interpersonal Circumplex** | Theory (Leary 1957, Wiggins 1979) that all interpersonal behavior organizes around two orthogonal axes: **Warmth** (communion/affiliation) and **Dominance** (agency/control). The SPA confirms this: two clusters (C0 and C1) span all 7 traditions with near-orthogonal centroid vectors (84.8 degrees). A theory proposed from within one tradition, now confirmed across seven. |
