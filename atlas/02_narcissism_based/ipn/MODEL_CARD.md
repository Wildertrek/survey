...
|-------------|----------|-------|
| Exp1 baseline (1536-dim) | 46.5% | — |
| RQ9: 3072-dim embeddings | 41.4% | -5.0% |
| RQ7: Data augmentation | 72.7% | +26.3% |
| **Best result** | **72.7%** | **+26.3%** |

Best intervention: Data augmentation (90 LLM-generated items).
