...
|-------------|----------|-------|
| Exp1 baseline (1536-dim) | 47.5% | — |
| RQ9: 3072-dim embeddings | 54.6% | +7.1% |
| RQ7: Data augmentation | 63.8% | +16.3% |
| **Best result** | **63.8%** | **+16.3%** |

Best intervention: Data augmentation (132 LLM-generated items).
