...
|-------------|----------|-------|
| Exp1 baseline (1536-dim) | 37.8% | — |
| RQ9: 3072-dim embeddings | 44.6% | +6.8% |
| RQ7: Data augmentation | 74.3% | +36.5% |
| **Best result** | **74.3%** | **+36.5%** |

Best intervention: Data augmentation (95 LLM-generated items).
